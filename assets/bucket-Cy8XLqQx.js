import{z as Fe,r as h,b as F,j as e,R as ke,g as _e,u as he,d as ne,m as j,i as M,k as O,h as le,n as ze,e as ce,A as Ie,o as $e,D as De,q as We,t as Oe,v as Ue,p as qe,w as Be,E as V,x as He,y as Ge}from"./pageTransition-DPG00EJA.js";const Ve={some:0,all:1};function Ye(t,a,{root:n,margin:r,amount:s="some"}={}){const o=Fe(t),l=new WeakMap,u=i=>{i.forEach(f=>{const d=l.get(f.target);if(f.isIntersecting!==!!d)if(f.isIntersecting){const x=a(f);typeof x=="function"?l.set(f.target,x):c.unobserve(f.target)}else typeof d=="function"&&(d(f),l.delete(f.target))})},c=new IntersectionObserver(u,{root:n,rootMargin:r,threshold:typeof s=="number"?s:Ve[s]});return o.forEach(i=>c.observe(i)),()=>c.disconnect()}function Ce(t,{root:a,margin:n,amount:r,once:s=!1}={}){const[o,l]=h.useState(!1);return h.useEffect(()=>{if(!t.current||s&&o)return;const u=()=>(l(!0),s?void 0:()=>l(!1)),c={root:a&&a.current||void 0,margin:n,amount:r};return Ye(t.current,u,c)},[a,t,n,s,r]),o}/**
